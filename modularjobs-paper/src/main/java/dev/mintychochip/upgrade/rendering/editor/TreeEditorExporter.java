...
public final class TreeEditorExporter {
  ...
  @Contract(pure = true)
  public @NotNull String export(@NotNull EditorTree tree) {
  ...
  @Contract(pure = true)
  public @NotNull String exportSingle(@NotNull EditorTree tree) {
    return gson.toJson(exportTree(tree));
  }

  @Contract(pure = true)
  private @NotNull JsonObject exportTree(@NotNull EditorTree tree) {
  ...
  @Contract(pure = true)
  private @NotNull JsonObject exportNode(@NotNull EditorNode node) {
    JsonObject obj = new JsonObject();
  ...
  @Contract(pure = true)
  private @NotNull JsonObject exportEffect(@NotNull EditorEffect effect) {
    JsonObject obj = new JsonObject();
